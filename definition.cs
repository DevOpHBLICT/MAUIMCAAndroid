...
<p>As a result of those care and support needs is unable to protect themselves from abuse or neglect or the risk of it. </div>
            ...
            Button yes = new Button { FontSize = Device.GetNamedSize(NamedSize.Medium, typeof(Label)), Text = "What is Safeguarding?", IsVisible = true, ImageSource = "tick", BackgroundColor = Color.FromHex("#953735"), TextColor = Color.FromHex("FFFFFF") };
