...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3054435858056262997, ; hash 0x2a63893ad4a8b555, from name: MCA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7314401530807463680, ; hash 0x6581f9705c5a2f00, from name: aot-MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 166
	...
	%struct.DSOCacheEntry {
		i64 8500758497194778806, ; hash 0x75f8c2d072ada0b6, from name: libaot-MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 205
	...
	%struct.DSOCacheEntry {
		i64 10638733138413702715, ; hash 0x93a45f6c47534e3b, from name: aot-MCA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 14818249233581700870, ; hash 0xcda4ff2ae0d77706, from name: libaot-MCA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 387
	...
	%struct.DSOCacheEntry {
		i64 17031380558597712265, ; hash 0xec5b9e61c5b5e989, from name: MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 445
...
@.env.3 = private unnamed_addr constant [37 x i8] c"b77d8a23-b562-463d-a5ed-52e8edf2500b\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [19 x i8] c"hbl_hsab_mca.Droid\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [18 x i8] c"libaot-MCA.dll.so\00", align 16
