...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1066168656, ; hash 0x3f8c7150, from name: MCA.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1766150837, ; hash 0x694552b5, from name: aot-MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 184
	...
	%struct.DSOCacheEntry {
		i64 2011845284, ; hash 0x77ea52a4, from name: libaot-MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 215
	...
	%struct.DSOCacheEntry {
		i64 2960038101, ; hash 0xb06e98d5, from name: libaot-MCA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 335
	...
	%struct.DSOCacheEntry {
		i64 3312351982, ; hash 0xc56e7aee, from name: aot-MCA.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 378
	...
	%struct.DSOCacheEntry {
		i64 4227488094, ; hash 0xfbfa595e, from name: MCA
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MCA.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
